...
public class SpuController {
    ...
    public Result putMany(@RequestBody Long[] ids)
    {
        ...
        if (count == ids.length)
        {
            return new Result(true,StatusCode.OK,"批量上架成功,共"+count+"个商品");
        }else {
            return new Result(true,StatusCode.ERROR,"批量上架失败");
        }
    }
    ...
    public Result restore(@PathVariable Long id)
    {
        ...
        return new Result(true,StatusCode.OK,"商品数据恢复成功");
    }
}
